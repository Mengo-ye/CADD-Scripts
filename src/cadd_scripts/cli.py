...
@click.option("-S", "--schrodinger", default=None, envvar="SCHRODINGER", type=click.Path(), help="Path to Schrödinger package (default: $SCHRODINGER).")
...
@click.option("-S", "--schrodinger", default=None, envvar="SCHRODINGER", type=click.Path(), help="Path to Schrödinger package (default: $SCHRODINGER).")
@click.option("-n", "--output-num", default=3, type=int, help="Number of output conformations per input.")
@click.option("-A", "--rosetta-app", default=None, envvar="rosetta_app", type=click.Path(), help="Path to Rosetta app (default: $rosetta_app).")
@click.option("-B", "--rosetta-db", default=None, envvar="rosetta_db", type=click.Path(), help="Path to Rosetta database (default: $rosetta_db).")
...
@click.option("-S", "--schrodinger", default=None, envvar="SCHRODINGER", type=click.Path(), help="Path to Schrödinger (default: $SCHRODINGER).")
@click.option("-R", "--rosetta-app", default=None, envvar="rosetta_app", type=click.Path(), help="Path to Rosetta app (default: $rosetta_app).")
@click.option("-B", "--rosetta-db", default=None, envvar="rosetta_db", type=click.Path(), help="Path to Rosetta database (default: $rosetta_db).")
...
@click.option("-m", "--mode", "running_mode", default="Fast", help="Predefined modes: Fast, Normal, Prep_Normal, Normal_MMGBSA, Reference, Cov_Screening, Induce_Fit_Screening, QM_Screening, Shape_Screening, LocalShape_Screening, Advance_Shape_Screening, Local, Advance, GeminiMol_Advance. Or custom pipeline (e.g. 'RDL+HTVS_Normal+SP_Normal').")
...
@click.option("-S", "--schrodinger", default=None, envvar="SCHRODINGER", type=click.Path(), help="Schrödinger path (default: $SCHRODINGER).")
...
def gvsrun(grid_input, database, database_path, running_mode, job_title,
    ...
    config = GVSRunConfig(
        ...
        shape_screen_switch=shape_screen is not None,
        force_field=force_field,
        coarse_ff=coarse_ff,
